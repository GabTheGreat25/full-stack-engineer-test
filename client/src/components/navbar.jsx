...
export function Navbar() {
  ...
  return (
    <>
      <div className="navbar bg-neutral-primary text-light-default dark:bg-light-default dark:text-dark-default">
        ...
        <div className="flex justify-end flex-1 2xl:px-2 xl-px-4 md:px-8">
          <div className="flex items-stretch gap-x-3">
            <a className="text-lg capitalize btn btn-ghost rounded-btn hover:bg-light-default hover:text-dark-default hover:dark:bg-dark-default hover:dark:text-light-default">
              Cart
            </a>
          </div>
        </div>
